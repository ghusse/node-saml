...
const metadata_1 = require("./saml/metadata");
...
class SAML {
    ...
    initialize(ctorOptions) {
        ...
        const options = {
            ...
            wantAssertionsSigned: (_r = ctorOptions.wantAssertionsSigned) !== null && _r !== void 0 ? _r : false,
            authnContext: (_s = ctorOptions.authnContext) !== null && _s !== void 0 ? _s : [
                "urn:oasis:names:tc:SAML:2.0:ac:classes:PasswordProtectedTransport",
            ],
            validateInResponseTo: (_t = ctorOptions.validateInResponseTo) !== null && _t !== void 0 ? _t : types_1.ValidateInResponseTo.never,
            cert: ctorOptions.cert,
            requestIdExpirationPeriodMs: (_u = ctorOptions.requestIdExpirationPeriodMs) !== null && _u !== void 0 ? _u : 28800000,
            cacheProvider: (_v = ctorOptions.cacheProvider) !== null && _v !== void 0 ? _v : new inmemory_cache_provider_1.InMemoryCacheProvider({
                keyExpirationPeriodMs: ctorOptions.requestIdExpirationPeriodMs,
            }),
            logoutUrl: (_x = (_w = ctorOptions.logoutUrl) !== null && _w !== void 0 ? _w : ctorOptions.entryPoint) !== null && _x !== void 0 ? _x : "",
            signatureAlgorithm: (_y = ctorOptions.signatureAlgorithm) !== null && _y !== void 0 ? _y : "sha1",
            authnRequestBinding: (_z = ctorOptions.authnRequestBinding) !== null && _z !== void 0 ? _z : "HTTP-Redirect",
            generateUniqueId: (_0 = ctorOptions.generateUniqueId) !== null && _0 !== void 0 ? _0 : crypto_1.generateUniqueId,
    ...
    _getAdditionalParams(relayState, operation, overrideParams) {
        return (0, common_1.getAdditionalParams)({
            relayState,
    ...
    async processValidlySignedAssertionAsync(xml, samlResponseXml, inResponseTo) {
        ...
        getInResponseTo: {
            ...
            if (subject) {
                ...
                subjectConfirmation = (_a = subject[0].SubjectConfirmation) === null || _a === void 0 ? void 0 : _a.find((_subjectConfirmation) => {
                    var _a;
    ...
    async _getNameIdAsync(self, doc) {
        ...
        if (encryptedIds.length === 1) {
            (0, utility_1.assertRequired)(self.options.decryptionPvk, "No decryption key found getting name ID for encrypted SAML response");
